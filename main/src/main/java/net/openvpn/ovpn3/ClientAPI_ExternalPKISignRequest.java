...
public class ClientAPI_ExternalPKISignRequest extends ClientAPI_ExternalPKIRequestBase {
    ...
    public void setPadding(String str) {
        ovpncliJNI.ClientAPI_ExternalPKISignRequest_padding_set(this.swigCPtr, this, str);
    }

    public String getPadding() {
        return ovpncliJNI.ClientAPI_ExternalPKISignRequest_padding_get(this.swigCPtr, this);
    }
