...
public class ClientAPI_OpenVPNClient extends ClientAPI_TunBuilderBase {
    ...
    public boolean socket_protect(int i, String str, boolean z) {
        return ovpncliJNI.ClientAPI_OpenVPNClient_socket_protect(this.swigCPtr, this, i, str, z);
    }
    ...
    public boolean remote_override_enabled() {
        return getClass() == ClientAPI_OpenVPNClient.class ? ovpncliJNI.ClientAPI_OpenVPNClient_remote_override_enabled(this.swigCPtr, this) : ovpncliJNI.m32x41a566c2(this.swigCPtr, this);
    }
    ...
    public void remote_override(ClientAPI_RemoteOverride clientAPI_RemoteOverride) {
        ...
        ovpncliJNI.m31xaf486d04(this.swigCPtr, this, ClientAPI_RemoteOverride.getCPtr(clientAPI_RemoteOverride), clientAPI_RemoteOverride);
    }
    ...
    public void clock_tick() {
        if (getClass() == ClientAPI_OpenVPNClient.class) {
            ...
            ovpncliJNI.m30x18e2e4a7(this.swigCPtr, this);
        }
    }
